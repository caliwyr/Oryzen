...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let guild = client.guilds.cache.get("871642960188571709")
...
\`\`\``
      ...
      await tempmsg.edit({embeds: [new MessageEmbed()
        .setColor(es.color).setFooter(client.getFooter(es))
        .setAuthor(`Successfully Reloaded:`, `https://cdn.discordapp.com/emojis/832687320465014834.gif?v=1`, `https://discord.gg/oryzen`)
