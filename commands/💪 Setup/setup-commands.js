  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      collector.on("collect", async b => {
        ...
        b?.reply(`<:yes:946018402273726464> **\`Enabled ${enabled} Command-Categories\` and \`Disabled ${disabled} Command-Categories\` out of \`${b?.values.length} selected Command-Categories\`**`)
      })
