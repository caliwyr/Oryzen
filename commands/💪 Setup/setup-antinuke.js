      ...
      async function first_layer(){
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            await message.reply({ content: "<:yes:946018402273726464> **The Current Anti-Nuke Settings**", embeds: [new MessageEmbed()
              .setColor(es.color)
              ...
              menuoptions = [
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.enabled") ? "904319985004978198": "832687320465014834"
                },
                {
                  value: "Set Logger",
                ...
                },
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog") ? "904319985004978198": "832687320465014834"
                },
                {
                      ...
                      menuoptions = [
                        {
                          ...
                          emoji: client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`) ? "904319985004978198": "832687320465014834"
                        },
                        {
            ...
            return menu?.reply({content: "<:yes:946018402273726464> **Now using the Suggested Settings!**", embeds: [new MessageEmbed()
              .setColor(es.color)
              .setFooter(client.getFooter(es))
