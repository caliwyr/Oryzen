        ...
        let menuoptions = [
          {
            ...
            emoji: `${client.settings.get(message.guild.id, `antidiscord.enabled`) ? "904319985004978198" : "832687320465014834"}`
          },
          {
            value: "Settings",
