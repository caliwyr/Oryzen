      ...
      if (args[0]) {
        ...
        let OverviewEmbed = new MessageEmbed()
          ...
          .addField(":muscle: **__My Features__**",
            `>>> **58+ Systems**, like: <:twitter:946106257285206107> **Twitter-** & <:Youtube:889437206362607656> **Youtube-Auto-Poster** 
**Application-**, Ticket-, **Welcome-Images-** and Reaction Role-, ... Systems
:notes: An advanced <:Spotify:941114038828552203> **Music System** with **Audio Filtering**
...
<:OryzenDev:946108153328709712>  Made by [**Oryzen Development**](https://discord.gg/oryzen)`)
      ...
      function allotherembeds_eachcategory(filterdisabled = false) {
        ...
        var embed1 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "💸 Economy").size}\`] 💸 Economy Commands 💸 | ${settings.ECONOMY ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
        ...
        var embed2 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🏫 School Commands").size}\`] 🏫 School Commands 🏫 | ${settings.SCHOOL ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
        ...
        var embed3 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎶 Music").size}\`] 🎶 Music Commands 🎶 | ${settings.MUSIC ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
          ...
          .addField("<:Disk:946109964802490400> **Song Commands**", "> " + client.commands.filter((cmd) => cmd.category === "🎶 Music" && cmd.type.includes("song")).sort((a, b) => a.name.localeCompare(b?.name)).map((cmd) => `\`${cmd.name}\``).join("︲"))
        ...
        var embed4 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "👀 Filter").size}\`] 👀 Filter Commands 👀 | ${settings.FILTER ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
        ...
        var embed5 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "⚜️ Custom Queue(s)").first().extracustomdesc.length}\`] ⚜️ Custom Queue(s) Commands ⚜️ | ${settings.CUSTOMQUEUE ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
          .setDescription(`> *${client.commands.filter((cmd) => cmd.category === "⚜️ Custom Queue(s)").first().extracustomdesc.split(",").map(i => i?.trim()).join("︲")}*`)
          .addField("\u200b", "\u200b")
          .addField("<:yes:946018402273726464>  **Usage**", "> " + client.commands.filter((cmd) => cmd.category === "⚜️ Custom Queue(s)").first().usage)
        ...
        var embed10 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "⌨️ Programming").size}\`] ⌨️ Programming Commands ⌨️ | ${settings.PROGRAMMING ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
        ...
        var embed11 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "📈 Ranking").size}\`] 📈 Ranking Commands 📈 | ${settings.RANKING ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
        ...
        var embed12 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🔊 Soundboard").size}\`] 🔊 Soundboard Commands 🔊 | ${settings.SOUNDBOARD ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
        ...
        var embed13 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎤 Voice").first().extracustomdesc.length}\`] 🎤 Voice Commands 🎤 | ${settings.VOICE ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
          .setDescription(`> *${client.commands.filter((cmd) => cmd.category === "🎤 Voice").first().extracustomdesc.split(",").map(i => i?.trim()).join("︲")}*`)
          .addField("\u200b", "\u200b")
          .addField("<:yes:946018402273726464>  **Usage**", "> " + client.commands.filter((cmd) => cmd.category === "🎤 Voice").first().usage)
        if (!filterdisabled || settings.VOICE || settings.showdisabled) embeds.push(embed13)

        //FUN COMMANDS
        var embed14 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🕹️ Fun").size}\`] 🕹️ Fun Commands 🕹️ | ${settings.FUN ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
        ...
        var embed15 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎮 MiniGames").size}\`] 🎮 Mini Games Commands 🎮 | ${settings.MINIGAMES ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
          .addField("\u200b", "__**Sub-Categorized Commands:**__")
        ...
        var embed16 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "😳 Anime-Emotions").size}\`] 😳 Anime Commands 😳 | ${settings.ANIME ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
        ...
        var embed17 = new MessageEmbed()
          .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🔞 NSFW").size}\`] 🔞 NSFW Commands 🔞 | ${settings.NSFW ? "<:yes:946018402273726464> ENABLED" : "<:no:904319985004978198> DISABLED"}`)
