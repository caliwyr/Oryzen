...
module.exports = {
	...
	run: async (client, message, args, cmduser, text, prefix) => {
		...
		try {	
			...
			let button_support_dc = new MessageButton().setStyle('LINK').setLabel(client.la[ls].cmds.info.github?.buttons.dc).setURL("https://discord.gg/oryzen")
			...
			message.reply({embeds: [new MessageEmbed()
				...
				.setTimestamp()
				.setThumbnail("https://cdn.discordapp.com/avatars/855595858954027049/df7b527a701d9a1ab6d73213576fe295.webp?size=1024")
