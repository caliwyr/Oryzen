...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let button_verify = new MessageButton().setStyle('SUCCESS').setCustomId('deleterole_verify').setLabel("Verify this Step").setEmoji("832687320465014834")
      ...
      collector.on('end', collected => {
          if (!edited) {
              ...
              msg.edit({
                  content: `<@${message.author.id}>`,
                  embeds: [endedembed],
                  components: [new MessageActionRow().addComponents(button_verify.setDisabled(true).setLabel("FAILED TO VERIFY").setEmoji("904319985004978198").setStyle('DANGER'))]
              }).catch((e) => {
                  console.log(String(e).grey)
              });
          }
