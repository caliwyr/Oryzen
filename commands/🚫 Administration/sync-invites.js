...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let approve = new MessageButton().setStyle('SUCCESS').setCustomId('1').setEmoji("832687320465014834").setLabel("YES DO IT!")
      let deny = new MessageButton().setStyle('PRIMARY').setCustomId('2').setEmoji("904319985004978198").setLabel("Cancel")
