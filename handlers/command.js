      ...
      member.send({
        embeds: [
          new MessageEmbed()
            .setColor(ee.color)
            .setThumbnail(member.guild.iconURL({dynamic: true}))
            .setAuthor(`Giveaway Entry Confirmed`, `https://cdn.discordapp.com/emojis/832687320465014834.gif?size=128`)
      ...
      member.send({
        embeds: [
          new MessageEmbed()
            .setColor(ee.wrongcolor)
            .setThumbnail(member.guild.iconURL({dynamic: true}))
            .setAuthor(`Giveaway Left!`, `https://cdn.discordapp.com/emojis/832687320465014834.gif?size=128`)
      ...
      winner.send({
        ...
        embeds: [
          new MessageEmbed()
            ...
            .setAuthor(`Giveaway Won!`, `https://cdn.discordapp.com/emojis/832687320465014834.gif?size=128`)
